...
3. Был написан функционал Корзины (рис. 2) согласно техническому заданию

![](./.images/cart.png)

Рисунок 2. Функционал корзины

4. Был написан функционал раздела Помощь (рис. 3) согласно техническому заданию

![](./.images/help.png)

Рисунок 3. Функционал помощи

4. При переходе по пути webhooks при помощи GET-запроса требовалось создать страницу управления подключенными вебхуками (рис. 4) с возможностью их добавления и удаления.
