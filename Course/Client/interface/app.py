...
def js_log_notify(message, msg_type):
    return eel.log_notify(message, msg_type)


def start_browser(event):
    eel.start("index.html", port=60441, cmdline_args=[], close_callback=event)
